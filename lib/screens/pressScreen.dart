...
class PressScreen extends StatefulWidget {
  ...
  @override
  State<PressScreen> createState() => _PressScreen();
}

class _PressScreen extends State<PressScreen> {
  ...
  Future<void> loadExercises() async {
    ...
    String data = await rootBundle.loadString('assets/press_exercises.txt');
  ...
  Future<void> loadTimerParams() async {
    ...
    var params = await _storageService.getPressParams();
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                await _storageService.setPressParams(_prepareController.text,
